...
sudo scutil --set ComputerName "Salman's MBP"
sudo scutil --set HostName "Salman's MBP"
sudo scutil --set LocalHostName "salmans-mbp"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Salman's MBP"
